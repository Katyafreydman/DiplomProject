...
public class CreditCardTest {
    ...
    public void shouldIfCardShortNumber() {
        var startPage = new StartPage();
        var cardPayment = startPage.creditCard();
        cardPayment.fillingCreditCardPaymentForm(DataHelper.getCardInfoShortNumber());
    ...
    public void shouldIfExpired6Years() {
        var startPage = new StartPage();
        var cardPayment = startPage.creditCard();
        cardPayment.fillingCreditCardPaymentForm(DataHelper.getCardInfoExpired6Years());
    ...
    public void shouldIfSymbolMonth() {
        var startPage = new StartPage();
        var cardPayment = startPage.creditCard();
        cardPayment.fillingCreditCardPaymentForm(DataHelper.getCardInfoSymbolMonth());
    ...
    public void shouldIfSymbolYear() {
        var startPage = new StartPage();
        var cardPayment = startPage.creditCard();
        cardPayment.fillingCreditCardPaymentForm(DataHelper.getCardInfoSymbolYear());
    ...
    // Отправка формы "Купить в кредит" с нулями в цифровых полях.

    // 1 Отправка формы "Купить в кредит" с нулевым значением в поле "Номер карты".
    @Test
    ...
    // 2 Отправка формы "Купить в кредит" с нулевым значением в поле "Месяц".
    @Test
    ...
    // 3 Отправка формы "Купить в кредит" с нулевым значением в поле "Год".

    @Test
    public void shouldIfYearNull() {
        var startPage = new StartPage();
        var cardPayment = startPage.creditCard();
        cardPayment.fillingCreditCardPaymentForm(DataHelper.getCardInfoYearNull());
        cardPayment.invalidFormatField();
    }

    // 4 Отправка формы "Купить в кредит" с нулевым значением в поле "CVC"
    @Test
    ...
    //  Отправка формы  "Купить в кредит" с пустыми полями

    //  1 Отправка пустой формы "Купить в кредит"

    @Test
    public void shouldIfEmptyForm() {
        var startPage = new StartPage();
        var cardPayment = startPage.creditCard();
        cardPayment.fillingCreditCardPaymentForm(DataHelper.getEmptyFields());
        cardPayment.invalidFormatField();
